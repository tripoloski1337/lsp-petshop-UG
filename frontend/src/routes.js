...
const DetailProd = React.lazy(() => import("./views/detail/produk/index"));
const Cart = React.lazy(() => import("./views/cart/index"));

const Mproduk = React.lazy(() => import("./views/admin/produk/index"));
const Musers = React.lazy(() => import("./views/admin/users/index"));
const Mcheckout = React.lazy(() => import("./views/admin/checkout/index"))
