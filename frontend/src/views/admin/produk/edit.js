...
class ProdukEdit extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    componentDidMount(){
        ...
        .then(data => this.setState({nama:data[0].nama_produk, price: data[0].harga, keterangan:data[0].keterangan}));
    }
    ...
    handleSubmit = (event) => {
        ...
        var urlpost = "http://localhost:8000/api/produk/edit";
        ...
        .then((result) => {
            ...
            if(result.data.msg == "exist"){
                ...
                this.setState({
                    error:window.location="/#/admin/produk"
                });
            }
        })
    }
